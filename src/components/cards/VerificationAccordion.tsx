...
import { CompleteKycUser } from "@/src/lib/types/KYCUser";
              ...
              <div className="space-y-3">
                ...
                <div className="break-all">
                  ...
                  <div className="text-gray-700">
                    {kycUser.personalIdentificationNumber}
                  </div>
                </div>
                ...
                <div className="break-words">
                  <span className="font-bold text-black">Occupation:</span>{" "}
                  {kycUser.occupation}
                </div>
                <div className="break-words">
                  <span className="font-bold text-black">Date of Birth:</span>{" "}
                  {formatDate(kycUser.dateOfBirth)}
                </div>
                <div className="break-words">
                  <span className="font-bold text-black">Place of Birth:</span>{" "}
                  {kycUser.placeOfBirth}
                </div>
                <div className="break-all">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 pl-2">
                      ...
                      <div className="break-words">
                        ...
                        {kycUser.residentialDistrict}
                      </div>
                      <div className="break-words">
                        <span className="font-semibold text-gray-700">
                          City:
                        </span>{" "}
                        {kycUser.residentialCity}
                      </div>
                      <div className="break-words">
                        <span className="font-semibold text-gray-700">
                          Postal Code:
                        </span>{" "}
                        {kycUser.residentialPostalCode}
                      </div>
                      <div className="break-words">
                        <span className="font-semibold text-gray-700">
                          Country:
                        </span>{" "}
                        {kycUser.residentialCountry}
                      </div>
                    </div>
                  </div>
                )}
