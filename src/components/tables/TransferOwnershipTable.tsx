...
const TransferOwnershipTable: React.FC<Props> = ({
  headings,
  users,
  handleSelectUser,
  selectedUserId,
          ...
          <tbody>
            {Array.isArray(users) &&
              users.map((user, index) => (
                ...
                >
                  <td className="px-2 sm:px-4 py-3 sm:py-4 font-satoshi min-w-[100px] whitespace-nowrap">
                    {user.id}
                  </td>
                  <td className="px-2 sm:px-4 py-3 sm:py-4 font-satoshi font-bold text-primary min-w-[100px] whitespace-nowrap">
                    {user.name}
                  </td>
                  <td className="px-2 sm:px-4 py-3 sm:py-4 font-satoshi min-w-[100px] whitespace-nowrap">
                    {user.email}
                  ...
                  <td className="px-2 sm:px-4 py-3 sm:py-4 font-satoshi min-w-[80px] whitespace-nowrap text-center">
                    <button
                    ...
                    >
                      <Image
                        ...
                        alt={
                          selectedUserId === user.id ? "Selected" : "Options"
                        }
                        width={24}
                        height={24}
